...
Page({
  ...
  clickscard:function(e){
    if(this.data.isshow == true && this.data.turn == "0" && this.data.finished == false){  //  1P回合时响应-S
      this.data.card = "Sx";
      this.SelectHand();
      this.data.turn="1";
      console.log("P1->S");
  ...
  clickhcard:function(e){
    if(this.data.isshow == true && this.data.turn=="0"&& this.data.finished == false){  //  1P回合时响应-H
      this.data.card = "Hx";
      this.SelectHand();
      this.data.turn="1";
      console.log("P1->H");
  ...
  clickccard:function(e){
    if(this.data.isshow == true && this.data.turn=="0"&& this.data.finished == false){  //  1P回合时响应-C
      this.data.card = "Cx";
      this.SelectHand();
      this.data.turn="1";
      console.log("P1->C");
  ...
  clickdcard:function(e){
    if(this.data.isshow == true && this.data.turn=="0"&& this.data.finished == false){  //  1P回合时响应-D
      this.data.card = "Dx";
      this.SelectHand();
      this.data.turn="1";
      console.log("P1->D");
  ...
  clickscard1:function(e){
    if(this.data.isshow1 == true && this.data.turn=="1"&& this.data.finished == false){  //  2P回合时响应-S
      this.data.card = "Sx";
      this.SelectHand();
      this.data.turn="0";
      console.log("P2->S");
  ...
  clickhcard1:function(e){
    if(this.data.isshow1 == true && this.data.turn=="1"&& this.data.finished == false){  //  2P回合时响应-H
      this.data.card = "Hx";
      this.SelectHand();
      this.data.turn="0";
      console.log("P2->H");
  ...
  clickccard1:function(e){
    if(this.data.isshow1 == true && this.data.turn=="1"&& this.data.finished == false){  //  2P回合时响应-C
      this.data.card = "Cx";
      this.SelectHand();
      this.data.turn="0";
      console.log("P2->C");
  ...
  clickdcard1:function(e){
    if(this.data.isshow1 == true && this.data.turn=="1"&& this.data.finished == false){  //  2P回合时响应-D
      this.data.card = "Dx";
      this.SelectHand();
      this.data.turn="0";
      console.log("P2->D");
  ...
  clickgcard:function(e){
    if(this.data.turn == "0"&&this.data.isshow == false){
      return;
    }else if(this.data.turn == "1"&&this.data.isshow1 == false){
      return;
    }
